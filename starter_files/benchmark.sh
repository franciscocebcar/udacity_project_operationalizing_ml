...
# Total:        114  160  28.0    172     199#
 ...
 ab -n 10 -v 4 -p data.json -T 'application/json' -H 'Authorization: Bearer uuP...Y0...' http://d258b07f-f6c5-49e5-a3ea-6c120b03f62c.southcentralus.azurecontainer.io/score
